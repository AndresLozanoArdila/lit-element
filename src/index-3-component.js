        ...
        <div class="d-flex justify-content-left ">
            ...
            <div class="row d-flex">
                <div class="row g-0 text-center pt-3 ">
                    ...
                    <div id="cajas2" class="col-md-5  pt-2">Campañas </div>
                </div>
                &nbsp&nbsp&nbsp
                &nbsp&nbsp&nbsp
                &nbsp&nbsp&nbsp
        ...
        <div id="cuadro" class="container border border-dark">
            <div class="d-flex p-3" >
                ...
                <div>
                    ...
                    <div class="user-campaign">Descripcion de la Campaña:Automoviles deportivos  <span>${this.campaignDesc}</span></div>
                </div>
            
                        <div class="container-campaign" style="border-radius: 1rem; width: 35rem; height: 11rem;">
                        <div class="user-campaign">Nombre del Usuario:Ávila </div>
                        <div class="user-campaign">Campaña del usuario:Automoviles superdeportivos  <span>${this.campaignDesc}</span></div>
                    </div>
                </div>
                </div>
